...
AliAnalysisTaskGammaConvV1::AliAnalysisTaskGammaConvV1(): AliAnalysisTaskSE(),
  ...
  fHistoTruePrimaryPi0MCPtResolPtFine(NULL),
  fHistoTruePrimaryEtaMCPtResolPtFine(NULL),
    ...
    if(fDoMesonAnalysis){
      ...
      if (fDoMesonQA > 0){
        ...
        if (fIsMC < 2){
          ...
          if (fDoMesonQA == 4){
            fHistoTruePrimaryPi0MCPtResolPtFine   = new TH2F*[fnCuts];
            fHistoTruePrimaryEtaMCPtResolPtFine   = new TH2F*[fnCuts];
          }
      ...
      if(fDoMesonAnalysis){
        ...
        if (fDoMesonQA > 0){
          if (fIsMC < 2){
            ...
            if (fDoMesonQA == 4){
              fHistoTruePrimaryPi0MCPtResolPtFine[iCut] = new TH2F("ESD_TruePrimaryPi0_MCPt_Pt_Fine", "ESD_TruePrimaryPi0_Pt_MCPt_Fine", nBinsPtFine, arrPtBinningFine, nBinsPtFine, arrPtBinningFine);
              fHistoTruePrimaryPi0MCPtResolPtFine[iCut]->Sumw2();
              fTrueList[iCut]->Add(fHistoTruePrimaryPi0MCPtResolPtFine[iCut]);
              fHistoTruePrimaryEtaMCPtResolPtFine[iCut] = new TH2F("ESD_TruePrimaryEta_MCPt_Pt_Fine", "ESD_TruePrimaryEta_Pt_MCPt_Fine", nBinsPtFine, arrPtBinningFine, nBinsPtFine, arrPtBinningFine);
              fHistoTruePrimaryEtaMCPtResolPtFine[iCut]->Sumw2();
              fTrueList[iCut]->Add(fHistoTruePrimaryEtaMCPtResolPtFine[iCut]);
            }
      ...
      if(!isPrimary){ // Secondary Meson
        ...
        if (fDoMesonQA > 0 && fIsMC < 2){
          ...
          if(isTruePi0){ // Only primary pi0 for resolution
            ...
            if (fDoMesonQA == 4) {
              fHistoTruePrimaryPi0MCPtResolPtFine[fiCut]->Fill(lMotherMCPt,
                                                               Pi0Candidate->Pt());
            }
          ...
          if (isTrueEta){ // Only primary eta for resolution
            fHistoTruePrimaryEtaMCPtResolPt[fiCut]->Fill(lMotherMCPt,
                                                         ...
                                                         weighted*weightMatBudget);
            if (fDoMesonQA == 4) {
              fHistoTruePrimaryEtaMCPtResolPtFine[fiCut]->Fill(lMotherMCPt,
                                                               Pi0Candidate->Pt());
            }
          }
        }
