...
{ 
    ...
    private:       
        ...
        It creates TF1 function objects that are driven from TH1_ExponentialInterpolation instances,
        ...
        */
        ...
        {   
            public:
                ...
                TH1_ExponentialInterpolation(TH1_ExponentialInterpolation const &) = delete;    
